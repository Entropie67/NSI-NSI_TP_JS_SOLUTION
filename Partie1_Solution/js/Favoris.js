...
function creerElementLien(lien) {
    // ################################################################################
    // On commence par créer une balise <a> qui va contenir le titre du lien cliquable. La partie orange.
    let titreLien = document.createElement("a"); // Création d'un élément <a>
    ...
    //#############################################################################
    let urlLien = document.createElement("span"); // Création d'un élément <span>
    ...
    let ligneTitre = document.createElement("p"); // Création d'un élément <p>
    ...
    let ligneDetails = document.createElement("span"); // Création d'un élément <span>
    ligneDetails.appendChild(document.createTextNode("Présenté par " + lien.auteur)); // On ajoute un noeud text à cette balise <span>

    let divLien = document.createElement("div"); // Création d'un élément <div>
